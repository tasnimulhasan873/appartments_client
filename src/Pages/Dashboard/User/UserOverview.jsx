...
const UserOverview = () => {
  // Example user stats
  const stats = [
    { label: "My Apartments", value: 1, icon: <FiHome /> },
    { label: "Profile Completed", value: "Yes", icon: <FiUser /> },
    { label: "Coupons Used", value: 2, icon: <FiAward /> },
  ];
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6 text-primary">User Overview</h1>
      ...
      <div className="glass-dark rounded-2xl p-8 shadow-lg">
        <h2 className="text-xl font-semibold mb-4 text-primary">User Charts</h2>
