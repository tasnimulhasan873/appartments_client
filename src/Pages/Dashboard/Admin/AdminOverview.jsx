...
const AdminOverview = () => {
  // Example admin stats
  const stats = [
    { label: "Managed Properties", value: 25, icon: <FiHome /> },
    { label: "Pending Requests", value: 8, icon: <FiClipboard /> },
    { label: "Active Members", value: 120, icon: <FiUserCheck /> },
  ];
  return (
    <div className="p-6">
      ...
      <div className="glass-dark rounded-2xl p-8 shadow-lg">
        <h2 className="text-xl font-semibold mb-4 text-primary">Admin Charts</h2>
